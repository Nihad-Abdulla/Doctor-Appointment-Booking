      ...
      <div className='w-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10'>
        ...
        <form className='py-4 md:py-0'>
          <div className='mb-5'>
            ...
            className='w-full px-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px]
          ...
          <p className='mt-5 text-textcolor text-center'>
            Dont  have an account ? <Link to='/register' className='text-primaryColor font-medium ml-1'>Register</Link>
          </p>
        </form>
      </div>
    </section>
